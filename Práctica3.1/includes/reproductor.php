...
class reproductor extends Podcast {   
    ...
    public function __construct($idPodcast, $descripcion,$nombrePodcast, $userPodcast, $fecha)
    {   
        parent::__construct($idPodcast, $descripcion,$nombrePodcast, $userPodcast, $fecha);
    }
...
$reproductor = new reproductor(null, null, null, null, null);
